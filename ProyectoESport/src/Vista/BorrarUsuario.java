...
public class BorrarUsuario extends javax.swing.JFrame {
    ...
    public BorrarUsuario() {
        ...
        ProyectoESport.llenarUsuariosID(jCombo);
    }
    ...
    private void jComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboActionPerformed
        ...
        try
        {
            ...
            String nom = ProyectoESport.seleccionarUnUsuario(id).getNombre();
            jNombre.setText(nom);
        }
        catch(Exception e)
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            int id = Integer.parseInt(jCombo.getSelectedItem().toString());
            ProyectoESport.bajaUsuario(id);
            JOptionPane.showMessageDialog(this,"El usuario ha sido dado de baja correctamente");
            ProyectoESport.volverPrincipalAdministrador(this);
        }
        catch(Exception e)
        {
