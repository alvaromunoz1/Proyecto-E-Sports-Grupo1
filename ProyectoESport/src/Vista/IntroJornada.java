 ...
 * @author 1GDAW02
 */
public class IntroJornada extends javax.swing.JFrame {

    /**
     * Creates new form IntroJornada
     */
    public IntroJornada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("INTRODUCIR JORNADA");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            validarDatosNuevos();
            ProyectoESport.insertarJornada(Integer.parseInt(jID.getText()), jNombre.getText(),Date.valueOf(jFecha.getText()),Integer.parseInt(jCalendario.getText()));
            JOptionPane.showMessageDialog(this,"La jornada ha sido introducido al registro correctamente");
    ...
    private void validarID() throws Exception{
        ...
        ArrayList<Jornada> per = ProyectoESport.datosTodasLasJornada();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntroJornada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IntroJornada().setVisible(true);
            }
        });
    }
