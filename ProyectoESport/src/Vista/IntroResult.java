        ...
        try{
            for(int x=0; x < jComboPartido.getItemCount(); x++)
            {
               if (datosCorrectos())
               {
                   ...
                   ProyectoESport.modificarResultadoDePartido(idp.getId(), Integer.parseInt(jRlocal.getText()), Integer.parseInt(jRvisit.getText()));
                   ProyectoESport.modificarPuntosDeEquipo(idp.getLocal().getId(), Integer.parseInt(jRlocal.getText()));
                   ProyectoESport.modificarPuntosDeEquipo(idp.getVisitante().getId(), Integer.parseInt(jRvisit.getText()));
